...
Hindsight 0.6.0 is a major release that adds an **Oracle 23ai database backend**, new integrations for **Dify**, **n8n**, **SmolAgents**, and **AWS Bedrock AgentCore**, plus a revamped **Claude Code plugin** with knowledge tools and subagents. On the reliability side, retain gets transactional atomicity fixes, BM25 search ranking is corrected, and entity timeline accuracy is improved.
