...
class MemoryApi:
    ...
    @validate_call
    async def dry_run_extract_memories(
        self,
        bank_id: StrictStr,
        ...
        :param bank_id: (required)
        :type bank_id: str
        :param dry_run_extract_request: (required)
        :type dry_run_extract_request: DryRunExtractRequest
        :param authorization:
        :type authorization: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._dry_run_extract_memories_serialize(
            bank_id=bank_id,
            dry_run_extract_request=dry_run_extract_request,
            authorization=authorization,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def dry_run_extract_memories_with_http_info(
        self,
        bank_id: StrictStr,
        dry_run_extract_request: DryRunExtractRequest,
        authorization: Optional[StrictStr] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DryRunExtractionResult]:
        """Dry-run fact extraction (preview, no persistence)
    ...
    @validate_call
    async def dry_run_extract_memories_without_preload_content(
        self,
        bank_id: StrictStr,
        dry_run_extract_request: DryRunExtractRequest,
        authorization: Optional[StrictStr] = None,
    ...
    def _dry_run_extract_memories_serialize(
        self,
        bank_id,
        dry_run_extract_request,
        authorization,
        _request_auth,
        _content_type,
        _headers,
        ...
        # process the form parameters
        # process the body parameter
        if dry_run_extract_request is not None:
            _body_params = dry_run_extract_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/default/banks/{bank_id}/memories/dry-run-extract',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _list_observation_scopes_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/default/banks/{bank_id}/observations/scopes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
